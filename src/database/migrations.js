...
const migrations = [
  ...
  },
  {
    ...
    sql: `ALTER TABLE user_buildings ADD COLUMN IF NOT EXISTS worker_count INT DEFAULT 0;
          ...
          ALTER TABLE user_buildings ADD COLUMN IF NOT EXISTS building_collect_x2_cooldown_until TIMESTAMP WITH TIME ZONE;
          ALTER TABLE user_buildings ADD COLUMN IF NOT EXISTS building_speedup_1h_cooldown_until TIMESTAMP WITH TIME ZONE;
