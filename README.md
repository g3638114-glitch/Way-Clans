...
- ✅ Модальные окна для продажи ресурсов и обмена Jamcoins (golds)
...
**Цены:**
- 🌲 Дерево: 10 Jamcoin (gold) за единицу
- 🪨 Камень: 15 Jamcoin (gold) за единицу
- 🍖 Мясо: 25 Jamcoin (gold) за единицу

### POST `/api/user/:userId/exchange`
Обменять Jamcoins на Jabcoins
...
**Курс:** 1,000,000 Jamcoin (gold) = 1 Jabcoin (минимум для обмена)
