...
export function updateExchangeResult() {
  ...
  document.getElementById('exchange-result').textContent = `💰 ${jabcoinsResult * 1000000}`;
}
...
export async function exchangeGold() {
  try {
    ...
    closeExchangeModal();
    tg.showAlert(`✅ Exchange successful! Received ${result.jabcoinsGained * 1000000} 💰 Jamcoin`);
  } catch (error) {
